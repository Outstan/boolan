...
import com.example.boolan.Adapter.HomecontentzAdapter;
...
public class PraiseFragment extends BaseFragment {
    ...
    public void submit() {
        HttpUtil.getAsyncGET(url + "/Home/praise?id=" + id, new Callback() {
            @Override
        ...
        try {
            ...
            if (!data.equals("")) {
                ...
                for (int i = 0; i < juser.length(); i++) {
                    ...
                    home.setSynopsis(jsonObject.getString("synopsis"));
            ...
            HomecontentzAdapter adapter = new HomecontentzAdapter(getActivity(), datas);
    ...
    public static PraiseFragment newInstance(String param) {

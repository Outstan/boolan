...
public class ZhuanfaFragment extends BaseFragment {
    ...
    public void submit() {
        HttpUtil.getAsyncGET(url + "/Home/zf?id=" + id, new Callback() {
            @Override
    ...
    public static ZhuanfaFragment newInstance(String param) {
        ZhuanfaFragment fragment = new ZhuanfaFragment();

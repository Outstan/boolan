...
public class TuijianFragment extends BaseFragment {
    ...
    public int getLayoutResId() {
        return R.layout.fragment_home_tuijian_fragment;
    }
    ...
    private void submit0() {
        HttpUtil.getAsyncGET(url + "/Home/connect?start=" + start + "&id=" + s.get("id"), new Callback() {
            @Override
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    ...
                    handleTuijianResult(msg.obj);
                    break;
            }
        }
    };

    public void handleTuijianResult(Object obj) {
